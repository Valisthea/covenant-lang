...
V0.9 is **testnet-only by design**. OMEGA V5 (internal) cleared all 10 verifications. External audit by a third-party firm (Trail of Bits, OpenZeppelin, or equivalent) is the gate for V1.0 mainnet. See [SECURITY.md](https://github.com/Valisthea/covenant-language/blob/main/SECURITY.md) for the disclosure policy.

## Next

- [V0.9 release notes](https://github.com/Valisthea/covenant-language/releases/tag/v0.9.0)
- [OMEGA V5 audit report](https://github.com/Valisthea/covenant-language/blob/main/OMEGA_V5_AUDIT_REPORT.md)
